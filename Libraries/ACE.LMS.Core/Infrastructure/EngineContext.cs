...
{
    /// <summary>
    /// Provides access to the singleton instance of the INSOL engine.
    /// </summary>
    public class EngineContext
    {
        #region Initialization Methods
        /// <summary>Initializes a static instance of the INSOL factory.</summary>
        ...
        public static IEngine CreateEngineInstance()
        {
            ...
            //        throw new ConfigurationErrorsException("The type '" + engineType + "' doesn't implement 'INSOL.Core.Infrastructure.IEngine' and cannot be configured in /configuration/nop/engine[@engineType] for that purpose.");
            //    return Activator.CreateInstance(engineType) as IEngine;
            //}

            return new ACEEngine();
        }

        #endregion

        /// <summary>Gets the singleton INSOL engine used to access INSOL services.</summary>

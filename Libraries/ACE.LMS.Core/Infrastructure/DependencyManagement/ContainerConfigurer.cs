...
namespace ACE.LMS.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Configures the inversion of control container with services used by INSOL.
    /// </summary>
    public class ContainerConfigurer
    {
        ...
        {
            //other dependencies
            //containerManager.AddComponentInstance<INSOLConfig>(configuration, "nop.configuration");

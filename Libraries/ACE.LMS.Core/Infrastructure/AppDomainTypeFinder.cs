...
{
    /// <summary>
    /// A class that finds types needed by INSOL by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether INSOL should iterate assemblies in the app domain when loading INSOL types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that INSOL assemblies arn't investigated (e.g. by not including something like "^INSOL|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the INSOL factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into INSOL.
        /// </returns>
